...
public class PantallaProductos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelTablaProductos = new moduloProductos.PanelVistaListaProductos();
    ...
    private void btnAgregarProductoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAgregarProductoActionPerformed
        control.pantallaAgregarProducto();
    }
    ...
    private void cargarDetalleDelProducto() {
        ...
        if (filaSeleccionada == -1) {
            JOptionPane.showMessageDialog(null, "Seleccione un producto para ver sus detalles", "Ha ocurrido un error inesperado", JOptionPane.INFORMATION_MESSAGE);
        } else {
    ...
    private moduloProductos.PanelVistaListaProductos panelTablaProductos;
