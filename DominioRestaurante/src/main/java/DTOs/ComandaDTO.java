...
public class ComandaDTO {
    ...
    /**
     * Identificador de la comanda en la base de datos, debe ser unico en el
     * sistema
     */
    private Long id;
    /**
    ...
    /**
     * Total de la venta de la comanda, se obtiene con la sumatoria de los
     * precios unitarios de los productor asociados a esta
     */
     ...
     * @param estado estado actual de la comanda
     * @param numeroMesa numero de la mesa asociada a la comanda
     * @param idCliente id del cliente asociado a la comanda
     * @param nombreCliente nombre del cliente asociado a la comanda
     */
    public ComandaDTO(Long id, Calendar fechaHora, double totalVenta, Estado estado, Long idCliente, String nombreCliente, String numeroMesa) {
        this.id = id;
        this.fechaHora = fechaHora;
        this.totalVenta = totalVenta;
        this.estado = estado;
     ...
     * @param nombreCliente nombre del cliente asociado a la comanda
     */
    public ComandaDTO(Calendar fechaHora, double totalVenta, Estado estado, String nombreCliente, Long idCliente, String numeroMesa) {
        this.fechaHora = fechaHora;
        this.totalVenta = totalVenta;
        this.estado = estado;
        this.nombreCliente = nombreCliente;
    ...
    /**
     * Establece el id del cliente asociado a la comanda
     *
     * @param idCliente id nuevo
     *
     */
