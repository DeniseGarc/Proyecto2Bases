...
/**
 *Interfaz que define las operaciones de lógica de negocio para la gestión de mesas
 * @author Maryr
 */
public interface IMesaBO {
    /**
     * Metodo que Inserta 20 mesas directamente a la base de datos
     * @throws exception.NegocioException Si ocurre algun error al insertar las mesas
     */
